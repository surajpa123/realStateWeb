    ...
    <div>
      ...
      <div className="flex flex-col gap-6 px-5 sm:px-3 py-28 justify-center max-w-6xl mx-auto">
        <h1 className="text-slate-700 text-3xl font-bold lg:text-6xl">
          Choose your next <br />{" "}
          <span className="text-orange-500">living</span> space
        </h1>

        <div className="text-grey-500 text-xs font-semibold sm:text-sm">
          We have wide range of{" "}
          <span className="text-orange-500">properties </span> to choose from.
        </div>

        <Link
          className="text-blue-700 font-semibold text-lg hover:underline lg:font-bold"
          to={"/search"}
        >
          Let's start now...
        </Link>
  ...
  sale.map((list)=>(
    ...
    <ListingItems listing={list} key={list._id}   />
      ...
      <div className="flex items-center gap-2 p-6 max-w-2xl justify-center mx-auto">
        <h2 className="text-slate-700 font-bold text-1xl">
          Design by <span className="text-orange-600">Suraj </span> with
        </h2>
